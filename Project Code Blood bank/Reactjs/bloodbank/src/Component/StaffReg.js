   ...
   <h3>Registration</h3>
        <form >
          ...
          <div className='mb-2 mt-2'>
            ...
            <input type="text" className='form-control'  id="fname" placeholder='Enter your First Name here' name="first_name" vlaue={first_name}  onChange={(ev)=>setFirst_name(ev.target.value)}  required></input>
          </div>
          <div className='mb-2 mt-2'>
            <label for="lname" className='form-lable'>Last Name</label>
            <input type="text" className='form-control myinput' id="lname"  placeholder='Enter your Last Name here' name="last_name" value={last_name}  onChange={(ev)=>setLast_name(ev.target.value)} required></input>
          </div>
          Gender<br />
          ...
          <div className='mb-2 mt-2'>
            ...
            <input type="date" className='form-control myinput' id="bdate" placeholder='Enter your BirthDate here'  name="dob" value={dob} onChange={(ev)=>setDob(ev.target.value)}></input>
          </div>
          <div className='mb-2 mt-2'>
            <label for="bloodtype" className='form-lable'>Blood Type</label>
            <input list="btype" className='form-control' id="bloodtype" placeholder='Enter your Blood type here' name="blood_type" value={blood_type} onChange={(ev)=>setBlood_type(ev.target.value)}/>
            <datalist id="btype">
          ...
          <div className='mb-2 mt-2'>
            ...
            <input type="email" className='form-control' id="Uname" placeholder='Enter Email here' name="email_ID" value={email_ID} onChange={(ev)=>setEmail_ID(ev.target.value)}></input>
          </div>
          <div className='mb-2 mt-2'>
            <label for="no" className='form-lable'>Number</label>
            <input type="text" pattern='\d*' className='form-control myinput'  id="no" placeholder='Enter Contact Number Here' name="contact_no" maxLength="10" value={contact_no} onChange={(ev)=>setContact_no(ev.target.value)}></input>
          </div>
          <div className='row'>
